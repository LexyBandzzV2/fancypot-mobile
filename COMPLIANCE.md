...
| Reviewer **demo account** | ✅ | Granted **Pro** and marked **phone-verified** directly in the DB (so reviewers skip the phone gate), closet **seeded with 7 items** across tops/bottoms/dresses/outerwear/shoes. Credentials are not stored in this repo — they live only in App Store Connect → App Review Information → Sign-In Information. |
